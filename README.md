...
## DevSpace Cheap: Web-orchestrated execution

The `devspace-cheap` branch keeps ChatGPT Web or Claude Web as the orchestrator.
The connected web model performs work through DevSpace tools and may delegate a
bounded task only through a configured DevSpace Subagent provider.
